...
class ReceivablePayableReport(object):
	...
	def get_columns(self):
		self.columns = []
		self.add_column('Posting Date', fieldtype='Date', width=120)
		...
		self.add_column(_('Total'), fieldname='paid')
		# if self.party_type == "Customer":
	...
	def setup_ageing_columns(self):
		...
		self.add_column(label=_('Age (Days)'), fieldname='age', fieldtype='Int', width=120)
